...
import { SocialService } from '../modules/home/services/social.service';
import { AutoPostService } from '../modules/home/services/auto-post.service';
...
export class HomeMessageHandler implements OnModuleInit {
  ...
  async handleGetFeed(@Payload() data: any) {
    try {
      ...
      return {
        success: true,
        data: await this.homeService.getFeed(
          userId,
  ...
  async handleUpdateMood(@Payload() data: any) {
    try {
      const { userId, payload } = data;
  ...
  async handleGetNotifications(@Payload() data: any) {
    try {
      const { userId } = data;
  ...
  async handleGetAutopostSettings() {
    try {
  ...
  async handleRunAutopost(@Payload() data: any) {
    try {
      const { payload } = data;
  ...
  async handleGetUserProfileData(@Payload() data: any) {
    try {
      const { payload } = data;
