    ...
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-gray-500 font-medium">
          <span className="hover:underline cursor-pointer">@{author?.username || 'nguoi-dung'}</span>
          <span>•</span>
  ...
  return (
    <div className={cn("flex items-center gap-2", layout === 'full' && "w-full")}>
      ...
      >
        ...
        >
          <ThumbsUp size={layout === 'compact' ? 16 : 20} className={cn(post.myReaction ? "" : "group-hover:scale-110 transition-transform")} />
