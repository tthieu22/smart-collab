...
export class HomeController {
  ...
  async createPost(@Body() body: any, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.post.create' }, { 
      userId: req.user.userId,
      payload: body 
    });
  }
  ...
  async likePost(@Param('id') postId: string, @Body('type') type: string, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.post.like' }, { 
      userId: req.user.userId,
      payload: { postId, type } 
    });
  }
  ...
  async addComment(@Param('id') postId: string, @Body('content') content: string, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.post.comment' }, { 
      userId: req.user.userId,
  ...
  async followUser(@Param('id') targetId: string, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.user.follow' }, { 
      userId: req.user.userId,
      payload: { targetId } 
    });
  }
  ...
  async unfollowUser(@Param('id') targetId: string, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.user.unfollow' }, { 
      userId: req.user.userId,
      payload: { targetId } 
    });
  }
  ...
  async updateUserMood(@Body('mood') mood: string, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.user.mood.update' }, { 
      userId: req.user.userId,
      payload: { mood } 
    });
  }
  ...
  async getNotifications(@Req() req: any) {
    return this.homeService.send({ cmd: 'home.notification.list' }, {
      userId: req.user.userId,
    });
  }
  ...
  async markNotificationRead(@Param('id') notificationId: string, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.notification.read' }, {
      userId: req.user.userId,
  ...
  async listNewsAdmin(
    ...
    return this.homeService.send({ cmd: 'home.news.list' }, { payload });
  }
  ...
  async createNews(
    ...
    return this.homeService.send({ cmd: 'home.news.create' }, {
      userId: req.user.userId,
      payload: body,
    });
  }
  ...
  async updateNews(
    ...
    return this.homeService.send({ cmd: 'home.news.update' }, {
      userId: req.user.userId,
      payload: { id, ...body },
    });
  }
  ...
  async getProfileData(@Body() body: any, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.user.profile.data' }, {
      userId: req.user.userId,
      payload: body,
    });
  }
  ...
  async getUserMedia(@Body() body: any, @Req() req: any) {
    return this.homeService.send({ cmd: 'home.user.media.get' }, {
      userId: req.user.userId,
      payload: body,
    });
  }
